...
# (i.e., render_template, redirect) that you will be using in your application.
from flask import Flask, request, render_template, redirect, flash, session

# import desired survey from the [survey.py] file.
...
def handle_question():
    """Save the user's response and redirect them to next question."""

    # Get the response choice.
    choice = request.form["answer"]

    # Add this response to the [session] object...
    # The [session] object allows you to store info, specific...
    # to a user, from one request to the next.
